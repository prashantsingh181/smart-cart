...
const Popup = () => {
  ...
  if (popup.isVisible) {
    return (
      <div
        className={`${
          popup.isError ? "bg-red-300" : "bg-green-300"
        } fixed z-20 top-24 right-8 flex flex-row gap-5 items-center bg-opacity-20 backdrop-blur-sm p-2 rounded border-gray shadow-lg`}
      >
