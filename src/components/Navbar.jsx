...
const Navbar = ({ isOpen }) => {
    ...
    return (
        <nav className={`p-4 font-inter text-lg shadow lg:shadow-none absolute lg:static z-[-10] right-0 top-0 pt-16 lg:p-0 lg:ml-auto w-48 lg:w-auto h-screen lg:h-auto bg-black ${isOpen ? "block" : "hidden"} lg:block`}>
